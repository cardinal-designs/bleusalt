...
class CartDrawer extends HTMLElement {
    ...
    quickAddClick(cardElement, event) {
      ...
      cardElement.querySelectorAll(".quick-add__button").forEach((t) => t.removeAttribute("selected")), t.target.setAttribute("selected", !0);
      let e = [];
      cardElement.querySelectorAll(".quick-add__button[selected]").forEach((t) => {
          e.push(t.value);
      });
      ...
      cardVariants.forEach((t) => {
        if (t.title === i) {
          console.log("✅ Match found:", t.title);
          // addToCart(t.id, 1);
          matchFound = true;
          return;
        } else {
          console.log("❌ No match for:", t.title);
        }
      });
