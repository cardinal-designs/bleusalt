...
class CartDrawer extends HTMLElement {
    ...
    quickAddClick(cardElement) {
      console.log("Click", cardElement)
    }
    quickAddIntialize(card) {
      console.log("card", card)
      card.forEach(function (element) {
        element.querySelectorAll('.quick-add__add-button').forEach(
          (button) => button.addEventListener('click', this.quickAddClick.bind(element))
        );
      })
    }
    wearWith(e = !1) {
