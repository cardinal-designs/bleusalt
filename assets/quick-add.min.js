    ...
    customElements.define(
        ...
        class extends HTMLElement {
            ...
            changeImage(t) {
                ...
                const e = images[1] || images[0]; // Use fallback if secondary image doesn't exist
                console.log("e", e);
                console.log("t.featured_image", t.featured_image);
            ...
            // changeImage(t) {
            //     const e = this.card.querySelectorAll(".card__media img")[1];
            //     console.log("e", e)
            //     console.log("t.featured_image", t.featured_image)
            //     if (t.featured_image) e.setAttribute("src", t.featured_image.src), e.removeAttribute("srcset");
            //     else {
            //         var i = !1,
            //             r = !1,
            //             s = this.card.querySelectorAll(".card__media img")[1];
            //         this.json.media.forEach((t) => {
            //             let o = t.alt.split("|")[0].trim();
            //             if ("image" != t.media_type || o !== this.selectedColor.value) return !0;
